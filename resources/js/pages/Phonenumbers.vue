                ...
                >
                    <template #select="{ row }">
                        <input
                            ...
                            class="mt-1.5 h-4 w-4 b rounded border-gray-300 text-primary focus:ring-primary"
                        />
                    </template>
                    ...
                    <template #phonenumber="{ row, value }">
                        <div class="space-y-1">
                            ...
                            <div v-if="row.deleted_at" class="flex items-center gap-2">
                                <span class="text-xs font-medium text-gray-400">Supprimé</span>
                            </div>
                            <div v-else-if="row.will_be_deleted" class="flex items-center gap-2">
                            ...
                            <div v-else-if="!row.sip_registered">
